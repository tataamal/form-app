            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bold">Helpdesk Kominfo</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" method="post" action="/submit-register">
                ...
                <div class="mb-3">
                    <label for="role" class="form-label dropdown">Jabatan</label>
                    <select class="form-select" name="role" id="role">
                        <option selected>Anda Masuk Sebagai Apa?</option>
