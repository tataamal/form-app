    ...
    <div class="row">
      ...
      <div class="col-xxl">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <form action="{{ url('user/update-restore', $restore->id_restore)}}" method="post">
            @csrf
              <div class="row mb-3">
                ...
                <div class="col-sm-10  mb-3">
                    <select class="form-select" name="periode" id="inputGroupSelect01">
                      <option selected>{{ $restore->periode }}</option>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="date" class="form-control" name="tanggal" id="basic-default-name" value="{{ $restore->tanggal }}" />
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10  mb-3">
                    <select class="form-select" name="objek" id="inputGroupSelect01">
                      <option selected>{{ $restore->objek }}</option>
                      @foreach ($data_backup as $item)
              ...
              <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="status" id="basic-default-name" value="{{ $restore->status }}" />
                  </div>
              </div>
              <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-default-name">Penanggung Jawab</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="pj" value="{{ $restore->pj }}" id="basic-default-name" placeholder="Masuka Nama Penanggung Jawab" />
                  </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea
                    ...
                    name="keterangan"
                    aria-describedby="basic-icon-default-message2">{{ $restore->keterangan }}</textarea>
                </div>
              </div>
              <div class="row mb-3">
              <div class="row mb-2">
